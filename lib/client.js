								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
									...
									children: [
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											...
											children: ["当前版本 v", updateStatus?.currentVersion ?? "4.0.9"]
										}),
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
...
`;
		...
		function BalanceWidget({ previewOverride, loadRouteEligibility, useSessions }) {
			...
			const [settingsNotice, setSettingsNotice] = (0, react.useState)();
			const [contextMenu, setContextMenu] = (0, react.useState)(null);
			const [intent, setIntent] = (0, react.useState)(() => previewOverride?.fixedPosition ?? loadPos());
			const [pos, setPos] = (0, react.useState)(intent);
			...
			const settingsNoticeTimer = (0, react.useRef)(void 0);
			...
			const showSettingsNotice = (0, react.useCallback)((message) => {
				setSettingsNotice(message);
				if (settingsNoticeTimer.current !== void 0) clearTimeout(settingsNoticeTimer.current);
				settingsNoticeTimer.current = setTimeout(() => {
					settingsNoticeTimer.current = void 0;
					setSettingsNotice(void 0);
				}, 4e3);
			}, []);
			...
			*/
			const toggleWhaleGirl = (0, react.useCallback)(() => {
				...
				saveSettings({
					...settingsRef.current === void 0 ? {} : { expectedRevision: settingsRef.current.revision },
			...
			const commitPos = (0, react.useCallback)((next) => {
				setIntent(next);
				savePos(next);
			}, []);
			/**
			...
			*/
			...
			const cardElement = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				ref: cardRef,
				style: {
					...CARD,
					left: pos.left,
				...
				children: [
					...
					settingsNotice !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						role: "status",
						"aria-live": "polite",
			...
			return (0, react_dom.createPortal)(cardElement, document.body);
		}
		//#endregion
		...
		*/
		const SESSION_HEADER_ACTIONS_SLOT = "conversation.session.header.actions";
		/**
		...
		*/
		...
		function apply(ctx) {
			...
			const slotsRegister = ctx.slots.register;
			const registerErased = (options, component) => slotsRegister.call(ctx.slots, options, component);
			ctx.slots.inject(SESSION_HEADER_ACTIONS_SLOT, () => registerErased({
				name: SESSION_HEADER_ACTIONS_SLOT,
				id: "token-monitor-session-cost",
				order: -5
			}, SessionCostBadge));
			ctx.slots.inject(SESSION_ROW_TRAILING_SLOT, () => registerErased({ name: SESSION_ROW_TRAILING_SLOT }, SessionCostBadge));
			ctx.slots.inject("shell.overlay", () => ctx.slots.register({
				name: "shell.overlay",
		...
		exports.SESSION_HEADER_ACTIONS_SLOT = SESSION_HEADER_ACTIONS_SLOT;
